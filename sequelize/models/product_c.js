...
class Product_C extends Model {}

Product_C._sequelize = null;

Product_C.isSequelized = function() {
...
Product_C.initModel = function(sequelize) {
    ...
    this.init({
        ...
        attr_a_6: { type: DataTypes.STRING },
        attr_a_7: { type: DataTypes.STRING }
    }, { sequelize: this._sequelize, modelName: 'product_c' });
}

Product_C.get = function(searchCondition, searchOption=null) {
...
Product_C.add = function(newUser) {
...
Product_C.delete = function(user_id) {
